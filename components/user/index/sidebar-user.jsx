        ...
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0" style={{backgroundColor: "#0f2865", borderTopRightRadius: "1rem", borderBottomRightRadius: "1rem"}}>
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 min-vh-100" style={{color: "#f3f4fc"}}>
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    <li class="nav-item">
                        <a href="/homepage-user" class="nav-link align-middle px-0">
                            <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline">Hi !</span>
                        </a>
                    </li>
                    <li>
                        <a href="/homepage-user" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-table"></i> <span class="ms-1 d-none d-sm-inline">Home</span></a>
                    </li>
                    <li>
                        <a href="/balance" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-table"></i> <span class="ms-1 d-none d-sm-inline">Change Balance</span></a>
                    </li>
                    <li>
                        <a href="/history" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-people"></i> <span class="ms-1 d-none d-sm-inline">History</span> </a>
                    </li>
                    <li>
                        <a href="/transfer" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-people"></i> <span class="ms-1 d-none d-sm-inline">Transfer</span> </a>
                    </li>
                    <li>
